...
class generationController extends Controller
{
    ...
    public function get_add_sorties()
    {
        ...
        return view('Out.add')->with('types', $types, 'commandes', $commandes);
    }
    ...
    public function post_types(Request $request)
    {
      ...
      'Current_stock' => 'required',
        ...
        Session::flash('success', 'Vous Avez bien Ajouter votre Article');
    ...
    public function get_edit_page_types($id)
    {
        ...
        return view('type.edit')->with('types', $types, 'commandes', $commandes);
    }
    ...
    public function edit_page_types(Request $request, $id)
    {
      ...
      'fourni' => 'required',
        ...
        $types->update();
        Session::flash('success', 'Vous avez bien modifier votre Article');
