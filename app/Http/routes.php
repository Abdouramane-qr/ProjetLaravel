...
Route::get('recettes/edit/{id}/', 'RecettesController@edit')->name('recette.edit');

Route::put('recettes/edit/{id}/', 'RecettesController@update')->name('recette.update');
//--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------FOURNISSEURS--------------------------------------------------------------------------------------------------------
Route::post('fournis-store', 'FournisseurController@store')->name('fournis.store');
//--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------generedf
Route::get('generate-pdf', 'FournisseurController@generatePDF')->name('generate-pdf');
//..........................................................................Pending................................

//user order
Route::get('/user/orders', 'UserOrderController@index')->name('user.order');
Route::post('status-view/{id}', 'generationController@changeStatus')->name('status.order');

Route::get('In/add', 'CommandeController@generatePDFAvoir')->name('generate-pdf-avoir');
